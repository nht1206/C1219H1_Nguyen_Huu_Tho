package com.codegym.customermanagerpaging.controller;

import com.codegym.customermanagerpaging.model.Customer;
import com.codegym.customermanagerpaging.model.Province;
import com.codegym.customermanagerpaging.service.CustomerService;
import com.codegym.customermanagerpaging.service.ProvinceService;
...
public class CustomerController {
    ...
    public ModelAndView listCustomers(@RequestParam("s") Optional<String> s, @PageableDefault(size = 2) Pageable pageable){
        ...
        modelAndView.addObject("s", s.orElse(""));
        return modelAndView;
    }
